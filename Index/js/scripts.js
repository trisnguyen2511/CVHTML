...
var songs = [{
    ...
    url: "./Songs/3.1.0.7%202%20guitar%20Tris.wav",
...
function initPlayer() {
    ...
    fetch('https://api.github.com/repos/trisnguyen2511/CVHTML/contents/Songs?ref=main')
        ...
        .then(data => {
            ...
            songs.forEach(function (element) {
                element.artist = "Tris";
                element.picture = "images/5fc779186aa1140014eda0ae.png";
                element.name = changeName(element.name);
                element.url = element.download_url
            });
